...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>This website uses cookies to enhance your experience. By continuing to browse, you agree to the
                        use
                        of cookies.</p>
                </div>
    ...
    <div class="container">
        <section id="featuresSection" class="menu-section" style="display: none;">
            ...
            <p>The Pomodoro Feature allows you to use the Pomodoro Technique to work on your tasks. The Pomodoro
                Technique
                is a time management method that uses a timer to break down work into intervals, usually 25 minutes
                long,
                separated by short breaks. Each interval is called a pomodoro, which means tomato in Italian.</p>

            <p>With our app, you can adjust the duration of the pomodoros and the breaks according to your preferences.
                You
                can also choose from different sounds and notifications to remind you when to start and stop working. 🍅
            </p>
            ...
            <p>With our app, you can store your to-do list in a cookie, so you don't lose your data when you close the
                app.
                You can also access your to-do list from any device, as long as you use the same browser. 🍪</p>

            <p>My Pomolist is more than just a timer and a to-do list. It is a powerful tool to help you achieve your
                goals,
                whether they are personal or professional, big or small. Download My Pomolist today and start your
                journey
        ...
        <section id="pricingSection" class="menu-section" style="display: none;">
            ...
            <p>My Pomolist is the app that combines the Pomodoro Technique and a To-Do List to help you achieve your
                goals.
                And the best part is: it's completely free! 😍</p>

            <p>You can download and use My Pomolist without paying anything, ever. No hidden fees, no ads, no
                subscriptions.
        ...
        <section id="aboutSection" class="menu-section" style="display: none;">
            ...
            <p>The Pomodoro Technique is a time management method developed by Francesco Cirillo in the late 1980s.
                The technique uses a timer to break down work into intervals, usually 25 minutes long, separated by
                short
                breaks.
            ...
            <p>Our app, My Pomolist, is designed to help you apply the Pomodoro Technique to your daily tasks. With our
                app,
                you can:</p>
    ...
    <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-2 border-top">
            ...
            <ul class="nav col-md-4 justify-content-end">
                ...
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary footer-text"
                        id="featuresLink">Features</a>
                </li>
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary footer-text"
                        id="pricingLink">Pricing</a>
                </li>
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary footer-text"
